...
const Users = () => {
    ...
    const handleDelete = (id) => {
        ...
        const deleteUsers = async () => {
            const response = await fetch("https://thambapanni-backend.onrender.com/api/auth/" + id, {
                method: "DELETE"
            })
    ...
    useEffect(() => {
        ...
        const fetchUsers = async () => {
            const response = await fetch("https://thambapanni-backend.onrender.com/api/auth/all-users")
            const json = await response.json()
            if (response.ok) {
                setUsers(json)
            }
