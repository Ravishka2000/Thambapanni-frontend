...
const ManageHeritages = () => {
    ...
    const handleDelete = (id) => {
        axios.delete("https://thambapanni-backend.onrender.com/api/heritages/" + id, {
            headers: {
                ...
                <div style={{ width: 450, padding: "1rem 0" }}>
                    <Link to={"/api/createHeritages/"}>
                        <Button variant="contained" type="submit" sx={{
                            color: 'black', backgroundColor: "#3498DB ", width: '30ch', marginBottom: 2, fontWeight: "bold", boxShadow: "none", '&:hover': {
                                backgroundColor: '#3498DB ', boxShadow: "none"
                            }, color: "bkack", textDecoration: "bold"
                        }}>
