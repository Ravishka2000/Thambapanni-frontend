...
const EditProfile = ({ onEditToggle }) => {
    ...
    useEffect(() => {
        const fetchUser = async () => {
            const response = await fetch(`https://thambapanni-backend.onrender.com/api/auth/${user._id}`,
                {
                    headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        axios.put('https://thambapanni-backend.onrender.com/api/auth/update-guide', data, {
